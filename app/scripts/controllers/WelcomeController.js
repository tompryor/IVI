...
(function () {
    ...
    LibertyMutualIVIBaseApp.Controllers.WelcomeController = M.Controller.extend({
        ...
        _initLayout : function () {
            var layout = LibertyMutualIVIBaseApp.Layouts.WelcomeLayout.create(this);
        ...
        initViews: function(){
        	...
        	this._contentView = LibertyMutualIVIBaseApp.Views.WelcomeView.create({model: LibertyMutualIVIBaseApp.Models.UserModel});
